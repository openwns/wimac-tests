...
class Config(Frozen):
    ...
    maxBursts = numberOfTimeSlots * parametersPhy.subchannels / 2 #384 for DL2ULratio 4/4 and 96 subchannels
...
for i in xrange(Config.nBSs):
    ...
    if Config.schedStrategy == "PF":
        bs.dll.dlscheduler.config.txScheduler.strategy.subStrategies[0] = openwns.Scheduler.ProportionalFair()
        bs.dll.ulscheduler.config.rxScheduler.strategy.subStrategies[0] = openwns.Scheduler.ProportionalFair()
